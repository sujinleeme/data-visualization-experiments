...
import CoverImage from "../assests/CoverImage/index"
...
const image = `${process.env.PUBLIC_URL + "/background-small.jpg"}`
const hdUrl = `${process.env.PUBLIC_URL + "/background.jpg"}`
    ...
    <div className={classes.page}>
      ...
      <div>
        <Grid className={classes.page}>
          <CoverImage srcPreload={image} srcLoaded={hdUrl}/>
